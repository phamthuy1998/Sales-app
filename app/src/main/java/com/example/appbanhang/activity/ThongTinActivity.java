...
//        mMap.setMyLocationEnabled(true);
        ...
        LatLng ptit = new LatLng(10.847902, 106.787);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(ptit, 15));
        mMap.addMarker(new MarkerOptions()
                .position(ptit)
                .title("Học viện Công nghệ Bưu chính viễn thông cơ sở TP.HCM")
                .snippet("97 Đường Man Thiện, Hiệp Phú, Quận 9, Hồ Chí Minh, Việt Nam"));
